...
VNPAY_TMN_CODE = 'D8LC7ZKI'  # Website ID in VNPAY System, get from config
VNPAY_HASH_SECRET_KEY = 'SYNPRQJSHNJTIQWQZXBGNSZCGFQKJZJN'  # Secret key for create checksum,get from config
